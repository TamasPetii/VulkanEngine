...
std::vector<uint32_t> ShaderCompiler::Compile(const std::string& shaderFilePath, shaderc_shader_kind kind)
{
...
std::string ShaderCompiler::LoadGlslShader(const std::string& shaderFilePath)
{
...
std::vector<uint32_t> ShaderCompiler::CompileGlslToSpirv(const std::string& glslSource, const std::string& shaderFileName, shaderc_shader_kind kind)
{
