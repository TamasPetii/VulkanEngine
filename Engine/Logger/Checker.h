...
#define CHECK_ERROR_NULL_MESSAGE(function, message) if(function == 0) throw std::runtime_error(std::format("{} In file {} at line {} in function {}", message ,  __FILE__, __LINE__, __FUNCTION__));
...
#define CHECK_ERROR_NOTNULL_MESSAGE(function, message) if(function != 0) throw std::runtime_error(std::format("{} In file {} at line {} in function {}", message ,  __FILE__, __LINE__, __FUNCTION__));